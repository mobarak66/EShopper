...
Route::middleware(['auth:sanctum',config('jetstream.auth_session'),'verified'])->group(function () {
    ...
    Route::get('/sub-category/edit/{id}',[SubCategoryController::class,'edi t'])->name('sub-category.edit');
    ...
    Route::get('/customer/manage-customer', [CustomerController::class, 'manage'])->name('customer.manage');
