...
<html lang="en">
  <head>
    ...
    <meta name="description" content="EShopper Dashboard - Free Bootstrap 4 Admin Dashboard Template and UI Kit. It is very powerful bootstrap admin dashboard, which allows you to build products like admin panels, content management systems and CRMs etc.">

    <title>Sign In - EShopper Admin Dashboard Template</title>
            ...
            <div class="card-header bg-primary">
              <div class="app-brand">
                <a href="/index.html">
                  ...
                  <span class="brand-name">EShopper Dashboard</span>
                </a>
              </div>
            </div>
