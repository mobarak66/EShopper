      ...
      {{-- <div id="sidebar" class="sidebar sidebar-with-footer"> --}}
        ...
        <div class="app-brand">
          <a href="/index.html" title="Sleek Dashboard">
            ...
            <h1 class="brand-name">EShopper Dashboard</h1>
          </a>
        </div>
            ...
            <ul class="nav navbar-nav">
                  ...
                  <div class="card-body px-0 py-3">
                    <ul class="nav nav-tabs nav-style-border p-0 justify-content-between" id="myTab" role="tablist">
                      <li class="nav-item mx-3 my-0 py-0">
                        <a class="nav-link active pb-3" id="home2-tab" data-toggle="tab" href="#home2" role="tab"
                          aria-controls="home2" aria-selected="true">All (11)</a>
                      </li>

                      <li class="nav-item mx-3 my-0 py-0">
                        <a class="nav-link pb-3" id="profile2-tab" data-toggle="tab" href="#profile2" role="tab"
                          aria-controls="profile2" aria-selected="false">Msgs (6)</a>
                      </li>

                      <li class="nav-item mx-3 my-0 py-0">
                        <a class="nav-link pb-3" id="contact2-tab" data-toggle="tab" href="#contact2" role="tab"
                            ...
                            <a href="javscript:void(0)" class="media media-message media-notification">
                              ...
                              <div class="media-body d-flex justify-content-between">
                                <div class="message-contents">
                                  ...
                                  <p class="last-msg">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nam
                                    itaque doloremque odio, eligendi delectus vitae.</p>
                            ...
                            <a href="javscript:void(0)" class="media media-message media-notification media-active">
                              ...
                              <div class="media-body d-flex justify-content-between">
                                <div class="message-contents">
                                  ...
                                  <p class="last-msg">Donec mattis augue a nisl consequat, nec imperdiet ex rutrum.
                                    Fusce et vehicula enim. Sed in enim eu odio vehic.</p>
                            ...
                            <a href="javscript:void(0)" class="media media-message media-notification">
                              ...
                              <div class="media-body d-flex justify-content-between">
                                <div class="message-contents">
                                  ...
                                  <p class="last-msg font-size-14">Lorem ipsum dolor sit, amet consectetur adipisicing
                                    elit. Nam itaque doloremque odio, eligendi delectus vitae.</p>
                            ...
                            <a href="javscript:void(0)" class="media media-message media-notification">
                              ...
                              <div class="media-body d-flex justify-content-between">
                                <div class="message-contents">
                                  ...
                                  <p class="last-msg font-size-14">Add Dany Jones as your contact consequat nec
                                    imperdiet ex rutrum. Fusce et vehicula enim. Sed in enim.</p>
                            ...
                            <a href="javscript:void(0)" class="media media-message media-notification">
                              ...
                              <div class="media-body d-flex justify-content-between">
                                <div class="message-contents">
                                  ...
                                  <p class="last-msg font-size-14">Donec mattis augue a nisl consequat, nec imperdiet ex
                                    rutrum. Fusce et vehicula enim. Sed in enim eu odio vehic.</p>
                            ...
                            <a href="javscript:void(0)" class="media media-message media-notification">
                              ...
                              <div class="media-body d-flex justify-content-between">
                                <div class="message-contents">
                                  ...
                                  <p class="last-msg font-size-14">Nam ut nisi erat. Ut quis tortor varius, hendrerit
                                    arcu quis, congue nisl. In scelerisque, sem ut ve.</p>
                            ...
                            <a href="javscript:void(0)" class="media media-message media-notification">
                              ...
                              <div class="media-body d-flex justify-content-between">
                                <div class="message-contents">
                                  ...
                                  <p class="last-msg">Nam ut nisi erat. Ut quis tortor varius, hendrerit arcu quis,
              ...
              <li class="dropdown user-menu">
                <button href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                  <img src="{{ asset('/') }}admin/assets/img/user/admin.jpg" class="user-image" alt="User Image" />
                ...
                <ul class="dropdown-menu dropdown-menu-right">
                  ...
                  <li class="dropdown-footer">
                    {{-- <a href="index.html"> <i class="mdi mdi-logout"></i> Log Out </a> modified from ecom-batch5 on 03.02.2023--}} 
                    <a class="dropdown-item text-danger" href="#" onclick="event.preventDefault(); document.getElementById('logoutForm').submit();" ><i class="bx bx-power-off font-size-16 align-middle mr-1 text-danger"></i> Log Out</a>
